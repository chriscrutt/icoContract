...
@private
@constant
# checking to see if you delegated your vote to someone other than zero_address
...
@private
@constant
# checking if you voted and your votes have been deleted (delegated to zero_address)
...
@public
def __init__(_numberOfProposals: int128, _proposalNames: bytes32[2]):
